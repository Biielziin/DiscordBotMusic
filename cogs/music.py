...
class music(commands.Cog):
    ...
    @commands.command(name="help",alisases=['ajuda'],help="Comandos de ajuda")
    async def help(self,ctx):
        ...
        embedhelp = discord.Embed(
            ...
            description = helptxt+'\n[**Criador:** Biell#0001](https://discord.gg/9cnxcwPHyG)'
        )
    ...
    async def p(self, ctx: commands.Context, *, query:str = "Dubdogz live at sunset on a Brazilian coastline (Musical Freedom InsomniacTV Showcase) "):
    ...
    @commands.command(name= "stop", help="Parar a musica.",aliases=["parar", "sair", "leave", "l", "s"])
